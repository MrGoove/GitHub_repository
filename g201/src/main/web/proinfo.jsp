 ...
 <div class="mianCont">
  ...
  <div class="cont">
   ...
   <div id="tsShopContainer">
	<div id="tsImgS"><a href="images/012.jpg" title="Images" class="MagicZoom" id="MagicZoom"><img width="300" height="300" src="images/012.jpg" /></a></div>
	<div id="tsPicContainer">
		<div id="tsImgSArrL" onclick="tsScrollArrLeft()"></div>
		<div id="tsImgSCon">
			<ul>
				<li onclick="showPic(0)" rel="MagicZoom" class="tsSelectImg"><img height="42" width="42" src="images/014.jpg" tsImgS="images/014.jpg" /></li>
				<li onclick="showPic(1)" rel="MagicZoom"><img height="42" width="42" src="images/010.jpg" tsImgS="images/010.jpg" /></li>
				<li onclick="showPic(2)" rel="MagicZoom"><img height="42" width="42" src="images/012.jpg" tsImgS="images/012.jpg" /></li>
				<li onclick="showPic(3)" rel="MagicZoom"><img height="42" width="42" src="images/013.jpg" tsImgS="images/013.jpg" /></li>
				<li onclick="showPic(4)" rel="MagicZoom"><img height="42" width="42" src="images/011.jpg" tsImgS="images/011.jpg" /></li>
    ...
    <div class="proBoxRight">
     <h3 class="proTitle">${goods.goodsname}</h3>
     <div>商品编号： 334011 </div>
     <div>会员价：<strong class="red">${goods.goodsprice}</strong> </div>
     <div>单位：袋 </div>
     <div>库存：<strong class="red">[有货] </strong> ${goods.goodsplace}</div>
     <ul class="rongliang">
      <li>100ml</li>
      <li>200ml</li>
      <li>300ml</li>
     ...
     <div class="gc">
      <a href="order.jsp"><img src="images/goumai.png" width="117" height="36" /></a>&nbsp;&nbsp;
