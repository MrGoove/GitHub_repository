...
<body>
 <div class="mianCont">
  ...
  <div class="lsg">
   ...
   <form action="${pageContext.request.contextPath}/findGoodsByName.action" method="post" class="subBox">
    <div class="subBoxDiv">
     <input type="text" class="subLeft" name="goods.goodsname"/>
  ...
  <div class="pnt">
   ...
   <div class="pntRight">
    ...
    <div class="banner">
     <div id="kinMaxShow">
      <div>
       <a href="#"><img src="../images/zhipin005.jpg" width="756" height="310"/></a>
      </div> 		
      <div>
       <a href="#"><img src="../images/zhipin002.jpg" width="756" height="310"/></a>
      </div>
      <div>
       <a href="#"><img src="../images/zhipin003.jpg" width="756" height="310"/></a>
      </div>
      <div>
       <a href="#"><img src="../images/zhipin004.jpg" width="756" height="310"/></a>
      </div>
      <div>
       <a href="#"><img src="../images/zhipin001.jpg" width="756" height="310"/></a>
      </div>      
     </div><!--kinMaxShow/-->
    </div><!--banner/-->
   </div><!--pntRight/-->
